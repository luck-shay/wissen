...
export function WeekNav({ currentWeekMonday, onPrev, onNext, disablePrev = false }: WeekNavProps) {
  return (
    <div className="mb-4 space-y-3 reveal-up">
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-border/60 bg-card/80 px-2 py-1 shadow-[0_10px_24px_rgba(8,41,56,0.14)] backdrop-blur-md">
        <Button
          ...
          className="rounded-full border border-transparent hover:border-border/60 disabled:opacity-40"
        >
